...
void vehicle::drive()
{
    ...
    double cycle_duration = 1; //Duration of a single simulation cycle in milliseconds
    ...
    while (true)
    {
        ...
        if (time_since_last_update >= cycle_duration)
        {
            ...
            pos_street_ += speed_ * time_since_last_update / 1000;   // division by 1000 is because of conversion from milliseconds to seconds
